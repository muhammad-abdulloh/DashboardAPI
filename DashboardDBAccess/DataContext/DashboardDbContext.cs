...
namespace DashboardDBAccess.DataContext
{
    /// <summary>
    ...
    /// </summary>
    public abstract class DashboardDbContext : IdentityDbContext<User, Role, int, IdentityUserClaim<int>, UserRole, IdentityUserLogin<int>, IdentityRoleClaim<int>, IdentityUserToken<int>>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardDbContext"/> class.
        /// </summary>
        /// <param name="options"></param>
        protected DashboardDbContext(DbContextOptions options) : base(options) { }
