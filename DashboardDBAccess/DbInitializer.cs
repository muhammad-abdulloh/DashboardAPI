...
using DashboardDBAccess.Builders;
...
namespace DashboardDBAccess
{
    ...
    public static class DbInitializer
    {
        ...
        private static async Task GenerateDefaultRoles(RoleManager<Role> roleManager, DashboardDbContext context)
        {
        ...
        private static void AssignRolesToDefaultUsers(DashboardDbContext context)
        {
        ...
        private static void GenerateDefaultTags(DashboardDbContext context)
        {
        ...
        private static void GenerateDefaultCategories(DashboardDbContext context)
        {
        ...
        private static void GenerateDefaultPostTags(DashboardDbContext context)
        {
        ...
        private static void GenerateDefaultPosts(DashboardDbContext context)
        {
        ...
        private static void GenerateDefaultLikes(DashboardDbContext context)
        {
        ...
        private static void GenerateDefaultComments(DashboardDbContext context)
        {
            var volcanoes = context.Posts.Single(x => x.Name == "Volcanoes are cool");
        ...
        /// <summary>
        /// Fill the database with <see cref="DashboardDbContext"/> (Entity Framework).
        ...
        public static async Task SeedWithDefaultValues(DashboardDbContext context, RoleManager<Role> roleManager,
