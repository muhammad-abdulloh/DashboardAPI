...
namespace DashboardDBAccess.Extensions
{
    public static class ServiceCollectionExtensions
    {
            ...
            IConfiguration configuration)
        {
            ...
            {
                case "MsSQL":
                    services.AddDbContext<DashboardDbContext, MsSqlDbContext>(o => o.UseSqlServer(
                        configuration.GetConnectionString("Default")));
                    break;

                case "PostgreSQL": 
                    services.AddDbContext<DashboardDbContext, PostgreSqlDbContext>(o => o.UseNpgsql(
                    configuration.GetConnectionString("Default")));
                break;
                case "HerokuPostgreSQL":
                    ...
                    services.AddDbContext<DashboardDbContext, PostgreSqlDbContext>(o =>
