...
namespace DashboardAPI.Tests.ServicesTests
{
    public class TokenServiceTests : IClassFixture<DatabaseFixture>
    {
        ...
        public TokenServiceTests(DatabaseFixture databaseFixture)
        {
            ...
            _tokenService = new DashboardAPI.Services.TokenService.TokenService(
        ...
        {
            var userService = new DashboardAPI.Services.UserService.UserService(new UserRepository(_fixture.Db, _fixture.UserManager), new RoleRepository(_fixture.Db, _fixture.RoleManager),
