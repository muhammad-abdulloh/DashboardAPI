...
namespace DashboardAPI.Tests.ServicesTests
{
    public class UserServiceTests : IClassFixture<DatabaseFixture>
    {
        ...
        public UserServiceTests(DatabaseFixture databaseFixture)
        {
            ...
            _service = new DashboardAPI.Services.UserService.UserService(new UserRepository(_fixture.Db, _fixture.UserManager), new RoleRepository(_fixture.Db, _fixture.RoleManager), 
