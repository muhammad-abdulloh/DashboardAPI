...
using DashboardDBAccess.Tests.Builders;
using Xunit;

namespace DashboardDBAccess.Tests.RepositoriesTests
{
    public class PostsRepository
    {
        ...
        public void AddPost()
        {
            // Arrange
            var postRepository = new PostRepository(_fixture.Db);
            var userRepository = new DashboardDBAccess.Repositories.User.UserRepository(_fixture.Db, _fixture.UserManager);
            var categoryRepository = new DashboardDBAccess.Repositories.Category.CategoryRepository(_fixture.Db);
