...
namespace DashboardAPI.Models.DTOs.Like.Converters
{
    ...
    public class UpdateLikeConverter
        : ITypeConverter<UpdateLikeDto, DashboardDBAccess.Data.Like>
    {
        ...
        /// <inheritdoc />
        public DashboardDBAccess.Data.Like Convert(UpdateLikeDto source, DashboardDBAccess.Data.Like destination,
